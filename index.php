...
<html lang="en" class="no-js">
	<head>
		...
		<title>Home Page of ID Card</title>
	...
	<body>
		<div class="container">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller">
							<ul class="gn-menu">
								...
								<li><a class="gn-icon gn-icon-illustrator" href="#">Home</a></li>
			...
			<header>
				<h1>Welcome <?php echo $_SESSION['name']; ?> <!--<span>A sidebar menu as seen on the <a href="http://www.google.com/nexus/index.html">Google Nexus 7</a> page</span>--></h1>	
			</header> 
		</div><!-- /container -->
